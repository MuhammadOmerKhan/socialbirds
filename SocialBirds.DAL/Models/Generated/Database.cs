...
//     Connection String:      `Server=localhost\localhost;Database=SocialShareSolution;User ID=sa;password=**zapped**;`
//     Schema:                 ``
//     Include Views:          `False`
...
namespace SocialBirds.DAL.DataServices
{
	...
	public partial class SocialBirdsRepository : Database
	{
        ...
        public SocialBirdsRepository(string connectionString, string provider) 
